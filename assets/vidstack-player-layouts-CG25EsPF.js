var Ys=Object.defineProperty;var Zs=Object.getPrototypeOf;var Js=Reflect.get;var Xs=(e,t,s)=>t in e?Ys(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var I=(e,t,s)=>(Xs(e,typeof t!="symbol"?t+"":t,s),s),ie=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var v=(e,t,s)=>(ie(e,t,"read from private field"),s?s.call(e):t.get(e)),f=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},M=(e,t,s,n)=>(ie(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s);var y=(e,t,s)=>(ie(e,t,"access private method"),s),oe=(e,t,s)=>Js(Zs(e),s,t);import{n as w,p as ye,e as D,o as it,b as qe,a4 as tn,u as x,k as K,a5 as Ue,s as S,a6 as ze,a7 as k,a8 as ge,a9 as je,a0 as Ye,g as ut,h as Ze,aa as en,ab as Je,ac as Xe,ad as ts,ae as Dt,j as pt,af as sn,r as nn,ag as an,x as on,i as Q,J as _e,t as ln,C as es,d as ss,ah as ns,ai as rn,a2 as xe,l as Ct,Z as un,aj as cn,ak as dn,al as pn,am as mn,$ as as,a3 as Te}from"./vidstack-DWQEfrPg-HzF3ULQC.js";import{_ as is}from"./app-BuuBfveF.js";import{A as U,T as vn,D as Re,x as i,s as fn,$ as $n,L as we}from"./vidstack-CwTj4H1w-J1suOE4C.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mt={ATTRIBUTE:1,CHILD:2,BOOLEAN_ATTRIBUTE:4},Tt=e=>(...t)=>({_$litDirective$:e,values:t});let Se=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const ct=(e,t)=>{var s,n;const a=e._$AN;if(a===void 0)return!1;for(const l of a)(n=(s=l)._$AO)===null||n===void 0||n.call(s,t,!1),ct(l,t);return!0},It=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},ls=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),Tn(t)}};function _n(e){this._$AN!==void 0?(It(this),this._$AM=e,ls(this)):this._$AM=e}function xn(e,t=!1,s=0){const n=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(t)if(Array.isArray(n))for(let l=s;l<n.length;l++)ct(n[l],!1),It(n[l]);else n!=null&&(ct(n,!1),It(n));else ct(this,e)}const Tn=e=>{var t,s,n,a;e.type==Mt.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=xn),(s=(a=e)._$AQ)!==null&&s!==void 0||(a._$AQ=_n))};class rs extends Se{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),ls(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,a;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(a=this.disconnected)===null||a===void 0||a.call(this)),s&&(ct(this,t),It(this))}setValue(t){if(bn(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}var N,mt,Z,vt,de,ft,pe,Lt,us,Bt,cs;class wn extends rs{constructor(s){super(s);f(this,vt);f(this,ft);f(this,Lt);f(this,Bt);f(this,N,null);f(this,mt,!1);f(this,Z,null);M(this,mt,s.type===Mt.ATTRIBUTE||s.type===Mt.BOOLEAN_ATTRIBUTE)}render(s){return s!==v(this,N)&&(this.disconnected(),M(this,N,s),this.isConnected&&y(this,vt,de).call(this)),v(this,N)?y(this,ft,pe).call(this,ye(v(this,N))):U}reconnected(){y(this,vt,de).call(this)}disconnected(){var s;(s=v(this,Z))==null||s.call(this),M(this,Z,null)}}N=new WeakMap,mt=new WeakMap,Z=new WeakMap,vt=new WeakSet,de=function(){v(this,N)&&M(this,Z,D(y(this,Bt,cs).bind(this)))},ft=new WeakSet,pe=function(s){return v(this,mt)?ke(s):s},Lt=new WeakSet,us=function(s){this.setValue(y(this,ft,pe).call(this,s))},Bt=new WeakSet,cs=function(){var s;y(this,Lt,us).call(this,(s=v(this,N))==null?void 0:s.call(this))};function o(e){return Tt(wn)(w(e))}var J,$t,Gt,ht,me;class ds{constructor(t,s){f(this,ht);f(this,J,void 0);f(this,$t,void 0);I(this,"elements",new Set);f(this,Gt,qe(y(this,ht,me).bind(this)));M(this,J,t),M(this,$t,s)}connect(){y(this,ht,me).call(this);const t=new MutationObserver(v(this,Gt));for(const s of v(this,J))t.observe(s,{childList:!0,subtree:!0});it(()=>t.disconnect()),it(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){tn(t)?(s.textContent="",s.append(t)):(Re(null,s),Re(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}}J=new WeakMap,$t=new WeakMap,Gt=new WeakMap,ht=new WeakSet,me=function(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=v(this,J).flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&v(this,$t).call(this,this.elements)};let kn=0,St="data-slot-id";var X,Nt,tt,At;class Ce{constructor(t){f(this,tt);f(this,X,void 0);I(this,"slots");f(this,Nt,qe(y(this,tt,At).bind(this)));M(this,X,t),this.slots=new ds(t,y(this,tt,At).bind(this))}connect(){this.slots.connect(),y(this,tt,At).call(this);const t=new MutationObserver(v(this,Nt));for(const s of v(this,X))t.observe(s,{childList:!0});it(()=>t.disconnect())}}X=new WeakMap,Nt=new WeakMap,tt=new WeakSet,At=function(){for(const t of v(this,X))for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(St);a||s.setAttribute(St,a=++kn+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(St)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(St,a)}}};function ps({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return i`<svg
  ...
  >
    ${K(n)?hn(n):o(n)}
  </svg>`}var et,bt,Ft,ms,yt,ve;class Sn{constructor(t){f(this,Ft);f(this,yt);f(this,et,{});f(this,bt,!1);I(this,"slots");this.slots=new ds(t,y(this,yt,ve).bind(this))}connect(){this.slots.connect()}load(){this.loadIcons().then(t=>{M(this,et,t),M(this,bt,!0),y(this,yt,ve).call(this)})}}et=new WeakMap,bt=new WeakMap,Ft=new WeakSet,ms=function*(){for(const t of Object.keys(v(this,et))){const s=`${t}-icon`;for(const n of this.slots.elements)n.name===s&&(yield{icon:v(this,et)[t],slot:n})}},yt=new WeakSet,ve=function(){if(v(this,bt))for(const{icon:t,slot:s}of y(this,Ft,ms).call(this))this.slots.assign(t,s)};class vs extends Sn{connect(){super.connect();const{player:t}=x();if(!t.el)return;let s,n=new IntersectionObserver(a=>{var l;(l=a[0])!=null&&l.isIntersecting&&(s==null||s(),s=void 0,this.load())});n.observe(t.el),s=it(()=>n.disconnect())}}const le=new WeakMap,jt=Tt(class extends rs{render(e){return U}update(e,[t]){var s;const n=t!==this.G;return n&&this.G!==void 0&&this.ot(void 0),(n||this.rt!==this.lt)&&(this.G=t,this.dt=(s=e.options)===null||s===void 0?void 0:s.host,this.ot(this.lt=e.element)),U}ot(e){var t;if(typeof this.G=="function"){const s=(t=this.dt)!==null&&t!==void 0?t:globalThis;let n=le.get(s);n===void 0&&(n=new WeakMap,le.set(s,n)),n.get(this.G)!==void 0&&this.G.call(this.dt,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.dt,e)}else this.G.value=e}get rt(){var e,t,s;return typeof this.G=="function"?(t=le.get((e=this.dt)!==null&&e!==void 0?e:globalThis))===null||t===void 0?void 0:t.get(this.G):(s=this.G)===null||s===void 0?void 0:s.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}}),fs=je();function c(){return Ue(fs)}const Cn={colorScheme:"system",download:null,customIcons:!1,disableTimeSlider:!1,menuContainer:null,menuGroup:"bottom",noAudioGain:!1,noGestures:!1,noKeyboardAnimations:!1,noModal:!1,noScrubGesture:!1,playbackRates:{min:0,max:2,step:.25},audioGains:{min:0,max:300,step:25},seekStep:10,sliderChaptersMinWidth:325,hideQualityBitrate:!1,smallWhen:!1,thumbnails:null,translations:null,when:!1};var gt,st,E,_t,fe;class Yt extends es{constructor(){super(...arguments);f(this,_t);f(this,gt,void 0);f(this,st,w(()=>{const s=this.$props.when();return y(this,_t,fe).call(this,s)}));f(this,E,w(()=>{const s=this.$props.smallWhen();return y(this,_t,fe).call(this,s)}))}get isMatch(){return v(this,st).call(this)}get isSmallLayout(){return v(this,E).call(this)}onSetup(){M(this,gt,x()),this.setAttributes({"data-match":v(this,st),"data-sm":()=>v(this,E).call(this)?"":null,"data-lg":()=>v(this,E).call(this)?null:"","data-size":()=>v(this,E).call(this)?"sm":"lg","data-no-scrub-gesture":this.$props.noScrubGesture}),ss(fs,{...this.$props,when:v(this,st),smallWhen:v(this,E),userPrefersAnnouncements:S(!0),userPrefersKeyboardAnimations:S(!0),menuPortal:S(null)})}onAttach(s){ns(s,this.$props.colorScheme)}}gt=new WeakMap,st=new WeakMap,E=new WeakMap,_t=new WeakSet,fe=function(s){return s!=="never"&&(rn(s)?s:w(()=>s(v(this,gt).player.state))())},I(Yt,"props",Cn);const $s=Yt.prototype;Ye($s,"isMatch");Ye($s,"isSmallLayout");function hs(e,t){D(()=>{const{player:s}=x(),n=s.el;return n&&ut(n,"data-layout",t()&&e),()=>n==null?void 0:n.removeAttribute("data-layout")})}function P(e,t){var s;return((s=e())==null?void 0:s[t])??t}function Ae(){return o(()=>{const{translations:e,userPrefersAnnouncements:t}=c();return t()?i`<media-announcer .translations=${o(e)}></media-announcer>`:null})}function O(e,t=""){return i`<slot
    name=${`${e}-icon`}
    data-class=${`vds-icon vds-${e}-icon${t?` ${t}`:""}`}
  ></slot>`}function wt(e){return e.map(t=>O(t))}function p(e,t){return o(()=>P(e,t))}function De({tooltip:e}){const{translations:t}=c(),{remotePlaybackState:s}=k(),n=o(()=>{const l=P(t,"AirPlay"),r=Ze(s());return`${l} ${r}`}),a=p(t,"AirPlay");return i`
  ...
  `}function bs({tooltip:e}){const{translations:t}=c(),{remotePlaybackState:s}=k(),n=o(()=>{const l=P(t,"Google Cast"),r=Ze(s());return`${l} ${r}`}),a=p(t,"Google Cast");return i`
  ...
  `}function Ee({tooltip:e,ref:t=on}){const{translations:s}=c(),n=p(s,"Mute"),a=p(s,"Unmute");return i`
  ...
  `}function gs(){const{translations:e}=c(),{live:t}=k(),s=p(e,"Skip To Live"),n=p(e,"LIVE");return t()?i`
      ...
      `:null}function Pe(){return o(()=>{const{download:e,translations:t}=c(),s=e();if(en(s))return null;const{source:n,title:a}=k(),l=n(),r=Je({title:a(),src:l,download:s});return K(r==null?void 0:r.url)?i`
  ...
  `}function xs(e,t,s,n){let a=K(t)?document.querySelector(t):t;a||(a=e==null?void 0:e.closest("dialog")),a||(a=document.body);const l=document.createElement("div");l.style.display="contents",l.classList.add(s),a.append(l),D(()=>{if(!l)return;const{viewType:d}=k(),u=n();ut(l,"data-view-type",d()),ut(l,"data-sm",u),ut(l,"data-lg",!u),ut(l,"data-size",u?"sm":"lg")});const{colorScheme:r}=c();return ns(l,r),l}function Ts({placement:e,tooltip:t,portal:s}){const{textTracks:n}=x(),{viewType:a,seekableStart:l,seekableEnd:r}=k(),{translations:d,thumbnails:u,menuPortal:$,noModal:h,menuGroup:m,smallWhen:b}=c();if(w(()=>{var Fe;const G=l(),lt=r(),rt=S(null);ts(n,"chapters",rt.set);const Y=(Fe=rt())==null?void 0:Fe.cues.filter(Ve=>Ve.startTime<=lt&&Ve.endTime>=G);return!(Y!=null&&Y.length)})())return null;const C=w(()=>h()?Dt(e):b()?null:Dt(e)),B=w(()=>!b()&&m()==="bottom"&&a()==="video"?26:0),A=S(!1);function R(){A.set(!0)}function H(){A.set(!1)}const ot=i`
    <media-menu-items
  ...
  `;return i`
    <media-menu class="vds-chapters-menu vds-menu" @open=${R} @close=${H}>
  ...
  `}function En(e){return Q(e)?e.map(t=>({label:t,value:t.toLowerCase()})):Object.keys(e).map(t=>({label:t,value:e[t]}))}function Jt(){return i`
  ...
  `}const Wn={...Mn,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"},Le={...Pn,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"};function Kn(){return o(()=>{const{hasCaptions:e}=k(),{translations:t}=c();return e()?i`
      <media-menu class="vds-font-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[L({label:p(t,"Font"),children:[Qn(),Hn()]}),L({label:p(t,"Text"),children:[qn(),zn(),Un()]}),L({label:p(t,"Text Background"),children:[jn(),Yn()]}),L({label:p(t,"Display Background"),children:[Zn(),Jn()]}),L({children:[Xn()]})]}
        </media-menu-items>
      </media-menu>
    `:null})}function Qn(){return V({label:"Family",option:Dn,type:"fontFamily"})}function Hn(){return V({label:"Size",option:Wn,type:"fontSize"})}function qn(){return V({label:"Color",option:Oe,type:"textColor"})}function Un(){return V({label:"Opacity",option:Le,type:"textOpacity"})}function zn(){return V({label:"Shadow",option:In,type:"textShadow"})}function jn(){return V({label:"Color",option:Oe,type:"textBg"})}function Yn(){return V({label:"Opacity",option:Le,type:"textBgOpacity"})}function Zn(){return V({label:"Color",option:Oe,type:"displayBg"})}function Jn(){return V({label:"Opacity",option:Le,type:"displayBgOpacity"})}function Xn(){const{translations:e}=c();return i`
    <button class="vds-menu-item" role="menuitem" @click=${On}>
      <span class="vds-menu-item-label">${o(()=>P(e,"Reset"))}</span>
    </button>
  `}function V({label:e,option:t,type:s}){const{player:n}=x(),{translations:a}=c(),l=z[s],r=()=>P(a,e);function d(){ln(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let h=function(m){l.set(m.target.value),d()};return kt({label:o(r),children:i`
        <input
          ...
          @input=${h}
        />
      `})}if(t.type==="slider"){let h=function(A){l.set(A.detail+"%"),d()};const{min:m,max:b,step:T,upIcon:C,downIcon:B}=t;return te({label:o(r),value:o(l),upIcon:C,downIcon:B,isMin:()=>l()===m+"%",isMax:()=>l()===b+"%",children:i`
        <media-slider
          class="vds-slider"
          min=${m}
          max=${b}
  ...
  `}function ee({label:e,checked:t,defaultChecked:s=!1,storageKey:n,onChange:a}){const{translations:l}=c(),r=n?localStorage.getItem(n):null,d=S(!!(r??s)),u=S(!1),$=o($n(d)),h=p(l,e);n&&a(ye(d)),t&&D(()=>void d.set(t()));function m(C){(C==null?void 0:C.button)!==1&&(d.set(B=>!B),n&&localStorage.setItem(n,d()?"1":""),a(d(),C),u.set(!1))}function b(C){_e(C)&&m()}function T(C){C.button===0&&u.set(!0)}return i`
    <div
  ...
  `}function As({placement:e,portal:t,tooltip:s}){return o(()=>{const{viewType:n}=k(),{translations:a,menuPortal:l,noModal:r,menuGroup:d,smallWhen:u}=c(),$=w(()=>r()?Dt(e):u()?null:Dt(e)),h=w(()=>!u()&&d()==="bottom"&&n()==="video"?26:0),m=S(!1);Ln();function b(){m.set(!0)}function T(){m.set(!1)}const C=i`
      <media-menu-items
    ...
    `})}function Be({orientation:e,tooltip:t}){return o(()=>{const{pointer:s,muted:n,canSetVolume:a}=k();if(s()==="coarse"&&!n())return null;if(!a())return Ee({tooltip:t});const l=S(void 0),r=sn(l);return i`
  ...
  `}function Ge(){const e=S(void 0),t=S(0),{thumbnails:s,translations:n,sliderChaptersMinWidth:a,disableTimeSlider:l,seekStep:r,noScrubGesture:d}=c(),u=p(n,"Seek"),$=o(l),h=o(()=>t()<a()),m=o(s);return ze(e,()=>{const b=e();b&&t.set(b.clientWidth)}),i`
    <media-time-slider
  ...
  `}function ya(){return o(()=>{const{live:e,duration:t}=k();return e()?gs():t()?i`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function Ds(){return o(()=>{const{live:e}=k();return e()?gs():ba()})}function Ms(){return o(()=>{const{textTracks:e}=x(),{title:t,started:s}=k(),n=S(null);return ts(e,"chapters",n.set),n()&&(s()||!t())?Ps():i`<media-title class="vds-chapter-title"></media-title>`})}function Ps(){return i`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Is extends vs{async loadIcons(){const t=(await is(()=>import("./vidstack-H72EDyqs-BfKhxBWu.js"),__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=ps({name:n,paths:t[n]});return s}}var q;let ga=(q=class extends Yt{},I(q,"props",{...oe(q,q,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),q);function _a(){return[Ae(),Ie(),i`
    ...
    `]}function xa(){return o(()=>{let e=S(void 0),t=S(!1),s=x(),{title:n,started:a,currentTime:l,ended:r}=k(),{translations:d}=c(),u=cn(e),$=()=>a()||l()>0;const h=()=>{const T=r()?"Replay":$()?"Continue":"Play";return`${P(d,T)}: ${n()}`};D(()=>{var T;u()&&document.activeElement===document.body&&((T=s.player.el)==null||T.focus({preventScroll:!0}))});function m(){const T=e(),C=!!T&&!u()&&T.clientWidth<T.children[0].clientWidth;T&&dn(T,"vds-marquee",C),t.set(C)}function b(){return i`
      ...
      `}return ze(e,m),n()?i`
        ...
        `:F()})}function Ta(){const e="top end";return[Ts({tooltip:"top",placement:e,portal:!0}),As({tooltip:"top end",placement:e,portal:!0})]}var xt,nt,Vt,Os,Rt,Ls,Et,Bs,Wt,Gs,Kt,Ns,Qt,Fs;class $e extends xe(we,ga){constructor(){super(...arguments);f(this,Vt);f(this,Rt);f(this,Et);f(this,Wt);f(this,Kt);f(this,Qt);f(this,xt,void 0);f(this,nt,S(!1))}onSetup(){this.forwardKeepAlive=!1,M(this,xt,x()),this.classList.add("vds-audio-layout"),y(this,Et,Bs).call(this)}onConnect(){hs("audio",()=>this.isMatch),y(this,Rt,Ls).call(this)}render(){return o(y(this,Vt,Os).bind(this))}}xt=new WeakMap,nt=new WeakMap,Vt=new WeakSet,Os=function(){return this.isMatch?_a():null},Rt=new WeakSet,Ls=function(){const{menuPortal:s}=c();D(()=>{if(!this.isMatch)return;const n=xs(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),a=n?[this,n]:[this];return(this.$props.customIcons()?new Ce(a):new Is(a)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},Et=new WeakSet,Bs=function(){const{pointer:s}=v(this,xt).$state;D(()=>{s()==="coarse"&&D(y(this,Wt,Gs).bind(this))})},Wt=new WeakSet,Gs=function(){if(!v(this,nt).call(this)){Ct(this,"pointerdown",y(this,Kt,Ns).bind(this),{capture:!0});return}Ct(this,"pointerdown",s=>s.stopPropagation()),Ct(window,"pointerdown",y(this,Qt,Fs).bind(this))},Kt=new WeakSet,Ns=function(s){const{target:n}=s;un(n)&&n.closest(".vds-time-slider")&&(s.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),v(this,nt).set(!0))},Qt=new WeakSet,Fs=function(){v(this,nt).set(!1),this.removeAttribute("data-scrubbing")},I($e,"tagName","media-audio-layout"),I($e,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wa=Tt(class extends Se{constructor(){super(...arguments),this.key=U}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(gn(e),this.key=t),s}}),dt=class dt extends Yt{};I(dt,"props",{...oe(dt,dt,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380});let he=dt;function Vs(){return o(()=>{const e=x(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=c();if(w(()=>t()||!s())())return null;const a=S(!1),{lastKeyboardAction:l}=e.$state;D(()=>{a.set(!!l());const m=setTimeout(()=>a.set(!1),500);return()=>{a.set(!1),window.clearTimeout(m)}});const r=w(()=>{var b;const m=(b=l())==null?void 0:b.action;return m&&a()?pt(m):null}),d=w(()=>`vds-kb-action${a()?"":" hidden"}`),u=w(ka),$=w(()=>{const m=Sa();return m?pn(m):null});function h(){const m=$();return m?i`
  ...
  `}function Ne(){const{menuGroup:e,smallWhen:t}=c(),s=()=>e()==="top"||t()?"bottom":"top",n=w(()=>`${s()} ${e()==="top"?"end":"center"}`),a=w(()=>`${s()} end`);return[Ts({tooltip:n,placement:a,portal:!0}),As({tooltip:n,placement:a,portal:!0})]}function Rs(){return o(()=>{const{noGestures:e}=c();return e()?null:i`
    ...
    `})}var at,Ht,Es,qt,Ws;class be extends xe(we,he){constructor(){super(...arguments);f(this,Ht);f(this,qt);f(this,at,void 0)}onSetup(){this.forwardKeepAlive=!1,M(this,at,x()),this.classList.add("vds-video-layout")}onConnect(){hs("video",()=>this.isMatch),y(this,Ht,Es).call(this)}render(){return o(y(this,qt,Ws).bind(this))}}at=new WeakMap,Ht=new WeakSet,Es=function(){const{menuPortal:s}=c();D(()=>{if(!this.isMatch)return;const n=xs(this,this.menuContainer,"vds-video-layout",()=>this.isSmallLayout),a=n?[this,n]:[this];return(this.$props.customIcons()?new Ce(a):new Is(a)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},qt=new WeakSet,Ws=function(){const{load:s}=v(this,at).$props,{canLoad:n,streamType:a,nativeControls:l}=v(this,at).$state;return!l()&&this.isMatch?s()==="play"&&!n()?Pa():a()==="unknown"?se():this.isSmallLayout?Ma():Ca():null},I(be,"tagName","media-video-layout"),I(be,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});const Ks=je();function g(){return Ue(Ks)}const Oa={clickToPlay:!0,clickToFullscreen:!0,controls:["play-large","play","progress","current-time","mute+volume","captions","settings","pip","airplay","fullscreen"],customIcons:!1,displayDuration:!1,download:null,markers:null,invertTime:!0,thumbnails:null,toggleTime:!0,translations:null,seekTime:10,speed:[.5,.75,1,1.25,1.5,1.75,2,4]};var Ut;class Qs extends es{constructor(){super(...arguments);f(this,Ut,void 0)}onSetup(){M(this,Ut,x()),ss(Ks,{...this.$props,previewTime:S(0)})}}Ut=new WeakMap,I(Qs,"props",Oa);function La(e,t){const{canAirPlay:s,canFullscreen:n,canPictureInPicture:a,controlsHidden:l,currentTime:r,fullscreen:d,hasCaptions:u,isAirPlayConnected:$,paused:h,pictureInPicture:m,playing:b,pointer:T,poster:C,textTrack:B,viewType:A,waiting:R}=t.$state;e.classList.add("plyr"),e.classList.add("plyr--full-ui");const H={"plyr--airplay-active":$,"plyr--airplay-supported":s,"plyr--fullscreen-active":d,"plyr--fullscreen-enabled":n,"plyr--hide-controls":l,"plyr--is-touch":()=>T()==="coarse","plyr--loading":R,"plyr--paused":h,"plyr--pip-active":m,"plyr--pip-enabled":a,"plyr--playing":b,"plyr__poster-enabled":C,"plyr--stopped":()=>h()&&r()===0,"plyr--captions-active":B,"plyr--captions-enabled":u},ot=mn();for(const G of Object.keys(H))ot.add(D(()=>void e.classList.toggle(G,!!H[G]())));return ot.add(D(()=>{const G=`plyr--${A()}`;return e.classList.add(G),()=>e.classList.remove(G)}),D(()=>{var Y;const{$provider:G}=t,lt=(Y=G())==null?void 0:Y.type,rt=`plyr--${Ba(lt)?"html5":lt}`;return e.classList.toggle(rt,!!lt),()=>e.classList.remove(rt)})),()=>ot.empty()}function Ba(e){return e==="audio"||e==="video"}class Ga extends vs{async loadIcons(){const t=(await is(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),__vite__mapDeps([]))).icons,s={};for(const n of Object.keys(t))s[n]=ps({name:n,paths:t[n],viewBox:"0 0 18 18"});return s}}function ne(e,t){var s;return((s=e())==null?void 0:s[t])??t}function Na(){return Ea()}function Fa(){const e=x(),{load:t}=e.$props,{canLoad:s}=e.$state;return w(()=>t()==="play"&&!s())()?[Hs(),He()]:[Va(),Ra(),He(),Wa(),ni(),ai()]}function Hs(){const e=x(),{translations:t}=g(),{title:s}=e.$state,n=o(()=>`${ne(t,"Play")}, ${s()}`);return i`
    <media-play-button
  ...
  `}function Va(){const{controls:e}=g();return o(()=>e().includes("play-large")?Hs():null)}function Ra(){const{thumbnails:e,previewTime:t}=g();return i`
    <media-thumbnail
      .src=${o(e)}
      class="plyr__preview-scrubbing"
      time=${o(()=>t())}
    ></media-thumbnail>
  `}function He(){const e=x(),{poster:t}=e.$state,s=o(()=>`background-image: url("${t()}");`);return i`<div class="plyr__poster" style=${s}></div>`}function Ea(){const e=new Set(["captions","pip","airplay","fullscreen"]),{controls:t}=g(),s=o(()=>t().filter(n=>!e.has(n)).map(qs));return i`<div class="plyr__controls">${s}</div>`}function Wa(){const{controls:e}=g(),t=o(()=>e().map(qs));return i`<div class="plyr__controls">${t}</div>`}function qs(e){switch(e){case"airplay":return Ka();case"captions":return Qa();case"current-time":return ei();case"download":return si();case"duration":return Us();case"fast-forward":return Za();case"fullscreen":return Ha();case"mute":case"volume":case"mute+volume":return Xa(e);case"pip":return Ua();case"play":return za();case"progress":return Ja();case"restart":return ja();case"rewind":return Ya();case"settings":return ii();default:return null}}function Ka(){const{translations:e}=g();return i`
  ...
  `}function Ha(){const{translations:e}=g(),t=_(e,"Enter Fullscreen"),s=_(e,"Exit Fullscreen");return i`
    <media-fullscreen-button
      class="plyr__controls__item plyr__control"
      data-no-label
  ...
  `}function qa(){const{translations:e}=g(),t=_(e,"Mute"),s=_(e,"Unmute");return i`
  ...
  `}function Ja(){let e=x(),{duration:t,viewType:s}=e.$state,{translations:n,markers:a,thumbnails:l,seekTime:r,previewTime:d}=g(),u=_(n,"Seek"),$=S(null),h=o(()=>{const A=$();return A?i`<span class="plyr__progress__marker-label">${os(A.label)}<br /></span>`:null});function m(A){d.set(A.detail)}function b(){$.set(this)}function T(){$.set(null)}function C(){const A=l(),R=o(()=>s()==="audio");return A?i`
        ...
        `}function B(){var R;const A=t();return Number.isFinite(A)?(R=a())==null?void 0:R.map(H=>i`
        <span
          class="plyr__progress__marker"
          @mouseenter=${b.bind(H)}
          @mouseleave=${T}
          style=${`left: ${H.time/A*100}%;`}
        ></span>
      `):null}return i`
  ...
  `}function Xa(e){return o(()=>{const t=e==="mute"||e==="mute+volume",s=e==="volume"||e==="mute+volume";return i`
  ...
  `}function ei(){const e=x(),{translations:t,invertTime:s,toggleTime:n,displayDuration:a}=g(),l=S(ye(s));function r(u){!n()||a()||as(u)&&!_e(u)||l.set($=>!$)}function d(){return o(()=>a()?Us():null)}return o(()=>{const{streamType:u}=e.$state,$=_(t,"LIVE"),h=_(t,"Current time"),m=o(()=>!a()&&l());return u()==="live"||u()==="ll-live"?i`
          <media-live-button
    ...
    <media-time
      ...
      aria-label=${t}
    ></media-time>
  `}function si(){return o(()=>{const e=x(),{translations:t,download:s}=g(),{title:n,source:a}=e.$state,l=a(),r=s(),d=Je({title:n(),src:l,download:r}),u=_(t,"Download");return K(d==null?void 0:d.url)?i`
          <a
            class="plyr__controls__item plyr__control"
            href=${Xe(d.url,{download:d.name})}
            download=${d.name}
            target="_blank"
          >
        ...
        `:null})}function ni(){return o(()=>{const{clickToPlay:e,clickToFullscreen:t}=g();return[e()?i`
          ...
          `:null,t()?i`
            <media-gesture
              ...
              action="toggle:fullscreen"
            ></media-gesture>
          `:null]})}function ai(){const e=x(),t=S(void 0),s=o(()=>{var n;return os((n=t())==null?void 0:n.text)});return D(()=>{const n=e.$state.textTrack();if(!n)return;function a(){t.set(n==null?void 0:n.activeCues[0])}return a(),Ct(n,"cue-change",a)}),i`
  ...
  `}function ae({label:e,children:t}){const s=S(!1);return i`
  ...
  `}function fi(e){return o(()=>e()?"true":"false")}function _(e,t){return o(()=>ne(e,t))}var W,zt,js;class zs extends xe(we,Qs){constructor(){super(...arguments);f(this,zt);f(this,W,void 0)}onSetup(){this.forwardKeepAlive=!1,M(this,W,x())}onConnect(){var s;(s=v(this,W).player.el)==null||s.setAttribute("data-layout","plyr"),it(()=>{var n;return(n=v(this,W).player.el)==null?void 0:n.removeAttribute("data-layout")}),La(this,v(this,W)),D(()=>{this.$props.customIcons()?new Ce([this]).connect():new Ga([this]).connect()})}render(){return o(y(this,zt,js).bind(this))}}W=new WeakMap,zt=new WeakSet,js=function(){const{viewType:s}=v(this,W).$state;return s()==="audio"?Na():s()==="video"?Fa():null},I(zs,"tagName","media-plyr-layout");Te($e);Te(be);Te(zs);
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/vidstack-H72EDyqs-BfKhxBWu.js","assets/vidstack-DWQEfrPg-HzF3ULQC.js"]
  }
